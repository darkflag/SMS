...
namespace SPBrowser.Entities
{
    public static class ClaimClientContext
    {
        ...
        /// <returns></returns>
        public static CookieCollection GetAuthenticatedCookies(string targetSiteUrl, int popUpWidth, int popUpHeight, out bool isCancelled)
        {
            ...
            using (ClaimsWebAuth webAuth = new ClaimsWebAuth(targetSiteUrl, popUpWidth, popUpHeight))
            {
                ...
                isCancelled = webAuth.IsCancelled;
            }
            return authCookie;
        }
        ...
        /// <param name="targetSiteUrl"></param>
        /// <returns></returns>
        public static ClientContext GetAuthenticatedContext(string targetSiteUrl, out bool isCancelled)
        {
            return (GetAuthenticatedContext(targetSiteUrl, 0, 0, out isCancelled));
        }
