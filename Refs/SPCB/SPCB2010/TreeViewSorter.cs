...
namespace SPBrowser
{
    public class TreeViewSorter : IComparer
    {
        public int Compare(object x, object y)
        {
            ...
            bool isNode1GeneralGroup = node1.Tag != null && node1.Tag.Equals(LoadType.GeneralGroup);
            bool isNode2GeneralGroup = node2.Tag != null && node2.Tag.Equals(LoadType.GeneralGroup);

            // Default sort based on alfabet
            if (node1.Parent != null &&
                node1.Parent.Tag != null &&
                node1.Parent.Tag.GetType().Equals(typeof(LoadType)) &&
                !isNode1GeneralGroup &&
                !isNode2GeneralGroup)
            {
